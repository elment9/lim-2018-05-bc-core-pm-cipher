describe('cipher', () => {
  ...
  describe('cipher.createCipherWithOffset', () => {
    ...
    it('debería retornar un objeto con funcion encode', () => {
      const estoEsUnObjeto = cipher.createCipherWithOffset(33)//Esto es un objeto
      assert.property(estoEsUnObjeto, 'encode'); //encode es la propiedad;
    });

    it('debería retornar un objeto con funcion decode', () => {
      const estoEsUnObjeto = cipher.createCipherWithOffset(33)//Esto es un objeto
      assert.property(estoEsUnObjeto, 'decode'); //encode es la propiedad;
    });
